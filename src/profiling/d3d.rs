...
use crate::renderer::d3d::{call_com_fn, SkiaRendererD3D};
...
pub fn create_d3d_gpu_context(name: &str, renderer: &SkiaRendererD3D) -> Box<dyn GpuCtx> {
    let context = &renderer.context;
    let queue = context.command_queue.clone();
